import{j as c}from"./index-DdklLgUG.js";const M=()=>c.jsx("svg",{width:"0",height:"0",style:{position:"absolute"},"aria-hidden":"true",children:c.jsx("defs",{dangerouslySetInnerHTML:{__html:p}})}),i=({n:d,size:a,fill:m=!1,className:h=""})=>c.jsx("svg",{className:`ic${m?" fill":""}${h?` ${h}`:""}`,viewBox:"0 0 24 24",style:a?{width:a,height:a}:void 0,"aria-hidden":"true",children:c.jsx("use",{href:`#mcmp-${d}`})}),p=`<g id="mcmp-trash"><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14"/></g>
