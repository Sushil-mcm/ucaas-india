...
export const SEARCHABLE_PAGES: SearchablePage[] = [
  ...
  { label: 'Company Info', path: '/admin-settings/company-info' },
  { label: 'People', path: '/admin-settings/users/extension' },
  { label: 'User Roles', path: '/admin-settings/users/role' },
  { label: 'User Departments', path: '/admin-settings/users/department' },
  ...
  { label: 'Settings', path: '/settings/basic-info' },
  { label: 'Basic Info Settings', path: '/settings/basic-info' },
