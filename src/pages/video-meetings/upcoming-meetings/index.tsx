...
const UpcomingMeetings = () => {
  ...
  return (
    <section className="flex h-full min-h-0 w-full flex-1 flex-col gap-3 overflow-auto p-3 sm:p-4">
      <div className="mx-auto max-w-[1200px] flex h-full min-h-0 w-full flex-col justify-start gap-6 sm:gap-8">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-3">
          ...
          <div ref={scrollContainerRef} className="flex flex-1 min-h-0 flex-col gap-3 ">
              {isPendingUpcomingMeeting ? (
                ...
                <div className="w-full mx-auto max-w-[1200px] min-h-52 lg:min-h-80 bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] p-4 rounded-lg   m-auto border border-[rgba(225,200,165,0.9)] flex flex-col items-center justify-center gap-2">
                  <div
