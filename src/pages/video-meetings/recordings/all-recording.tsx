...
const AllRecording = () => {
  ...
  const { data: recordingListData, isPending: isPendingRecordingList } = useQuery({
    ...
    queryFn: () => recordingList({ recordingType: 'ALL' }),
    select: (data) => data?.data?.data?.result,
  });

  const playbackUrl = selectedData?.fileUrl || '';
  console.log(playbackUrl, 'playbackUrlplaybackUrl');
        ...
        <div className="mx-auto max-w-250 w-full flex min-h-0 flex-1 flex-col gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <CustomTooltip text="Manage recordings, archives, and meeting transcripts." side="bottom" className="max-w-xs">
                  <button
                    ...
                    aria-label="About All Recordings"
                  >
          ...
          <RecordingListingTable
            ...
            onPlay={(record) => {
              ...
              console.log(record, 'recordrecord', mediaUrl);
