...
const greetingSidebarArr = (features: any): GreetingSidebarItem[] => {
  ...
  const items: (GreetingSidebarItem | false | undefined)[] = [
    ...
    {
      title: 'Schedules',
      path: '/reports/workforce/schedules',
      value: 'workforce-schedules',
      type: 'normal',
      icon: 'ReportsLineIcon',
    },
    {
      title: 'Adherence',
      path: '/reports/workforce/adherence',
      value: 'workforce-adherence',
      type: 'normal',
      icon: 'ReportsLineIcon',
    },
    {
      title: 'Time off',
      path: '/reports/workforce/time-off',
      value: 'workforce-time-off',
      type: 'normal',
      icon: 'ReportsLineIcon',
    },
    {
      title: 'Coverage',
      path: '/reports/workforce/coverage',
      value: 'workforce-coverage',
      type: 'normal',
      icon: 'ReportsLineIcon',
    },
    {
