...
export const ChatHeader = ({
  ...
  return (
    <>
      ...
      <div className="relative z-20 w-full min-h-14 shrink-0 border-b border-[rgba(225,200,165,0.9)] px-3 sm:px-4 flex items-center justify-between bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] gap-2 sm:gap-3">
              ...
              {!isMessageSelectionMode && !fromMeetChat ? (
                <CustomTooltip text="Summarize & ask AI" side="top">
                  <AiConversationInsights
                    ...
                    className="msgr-icon-btn w-9 h-9 rounded-full bg-gray-100 hover:bg-ucass-active hover:text-white"
                  />
                </CustomTooltip>
              ) : null}
