          ...
          <div className="flex flex-col gap-1 items-end">
            {window.location.pathname.includes('/agent-chat') ? null : (
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white/95 backdrop-blur-[12px] rounded-xl border-0 shadow-lg p-1.5 min-w-[220px]">
                  <DropdownMenuItem
            ...
            <div className="flex gap-1.5 shrink-0">
              {chatAccess?.access?.DIRECT_MESSAGE || chatAccess?.access?.TEAM_MESSAGE ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="bg-white rounded-xl border-0 shadow-lg p-1.5 min-w-[200px]">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white rounded-xl border-0 shadow-lg p-1.5 min-w-[180px]">
        ...
        {!isAgentChat ? (
          <div className="w-full sm:min-w-28 sm:w-28">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white rounded-xl border-0 shadow-lg p-1 min-w-[140px]">
      ...
      <div className="w-full h-full min-h-0 flex overflow-hidden bg-white">
        {chatType === 'chat' ? (
          <>
            <section
              className={cn(
                'h-full min-h-0 border-r border-[rgba(225,200,165,0.9)] bg-[rgba(251,249,246,0.88)] backdrop-blur-[12px] lg:w-[420px] lg:min-w-[420px] lg:max-w-[420px]',
