import{j as c}from"./index-C9cxWm34.js";const M=()=>c.jsx("svg",{width:"0",height:"0",style:{position:"absolute"},"aria-hidden":"true",children:c.jsx("defs",{dangerouslySetInnerHTML:{__html:p}})}),i=({n:d,size:a,fill:m=!1,className:h=""})=>c.jsx("svg",{className:`ic${m?" fill":""}${h?` ${h}`:""}`,viewBox:"0 0 24 24",style:a?{width:a,height:a}:void 0,"aria-hidden":"true",children:c.jsx("use",{href:`#mcmp-${d}`})}),p=`<g id="mcmp-home"><path d="M3 10.5 12 3l9 7.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z"/></g>
...
<g id="mcmp-refresh"><path d="M20.5 12a8.5 8.5 0 1 1-2.5-6M20.5 4v5h-5"/></g>`;export{i as I,M};
