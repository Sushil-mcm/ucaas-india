(() => {
  ...
  const A = function (A) {
    var g,
      I,
      Q = void 0 !== (A = A || {}) ? A : {};
    Q.ready = new Promise(function (A, Q) {
      (g = A), (I = Q);
    });
    var B,
      C = Object.assign({}, Q),
    ...
    (D || f) &&
      ...
      (w =
        0 !==
        (w =
          'file:///mnt/bigci/jobs/jitsi-meet/workspace/jitsi-meet/node_modules/@jitsi/rnnoise-wasm/dist/rnnoise-sync.js').indexOf(
          'blob:',
        )
    ...
    var P,
      i,
      H = Q.printErr || console.warn.bind(console);
    Object.assign(Q, C),
      (C = null),
      Q.arguments && (E = Q.arguments),
      Q.thisProgram && Q.thisProgram,
      Q.quit && Q.quit,
      Q.wasmBinary && (P = Q.wasmBinary),
      Q.noExitRuntime,
    ...
    function c(A) {
      try {
        return i.grow((A - o.byteLength + 65535) >>> 16), s(i.buffer), 1;
      } catch (A) {}
    }
    N(
      (z =
    ...
    ) || ((S = z), (z = Q.locateFile ? Q.locateFile(S, w) : w + S));
    var u =
      'function' == typeof atob
        ...
        : function (A) {
            ...
            do {
              (g =
                (D.indexOf(A.charAt(w++)) << 2) |
                ((B = D.indexOf(A.charAt(w++))) >> 4)),
                (I = ((15 & B) << 4) | ((C = D.indexOf(A.charAt(w++))) >> 2)),
                (Q = ((3 & C) << 6) | (E = D.indexOf(A.charAt(w++)))),
                (f += String.fromCharCode(g)),
                64 !== C && (f += String.fromCharCode(I)),
                64 !== E && (f += String.fromCharCode(Q));
            } while (w < A.length);
            return f;
          };
    function O(A) {
      if (N(A))
        return (function (A) {
          try {
            for (
              var g = u(A), I = new Uint8Array(g.length), Q = 0;
              Q < g.length;
              ++Q
            )
              I[Q] = g.charCodeAt(Q);
    ...
    var x,
          ...
          for (var B = 1; B <= 4; B *= 2) {
            ...
            if (
              ...
              c(
                Math.min(
                  Q,
                  (g = Math.max(A, C)) + ((65536 - (g % 65536)) % 65536),
                ),
              ))
            )
              return !0;
      ...
      T = (function () {
        ...
        function g(A, g) {
          ...
          (Q.asm = B),
            ...
            (function (A) {
              if (
                (R--,
                Q.monitorRunDependencies && Q.monitorRunDependencies(R),
                0 == R && (null !== y && (clearInterval(y), (y = null)), r))
              ) {
                var g = r;
                (r = null), g();
              }
        ...
        if (
          ...
          try {
            return Q.instantiateWasm(A, g);
          } catch (A) {
            return (
              H('Module.instantiateWasm callback failed with error: ' + A), !1
            );
          }
        return (
          g(
            (function (A, g) {
              ...
              try {
                (C = (function (A) {
                  try {
                    if (A == z && P) return new Uint8Array(P);
                    var g = O(A);
                    if (g) return g;
                    if (B) return B(A);
                  ...
                  (Q = new WebAssembly.Module(C)),
                  (I = new WebAssembly.Instance(Q, g));
              } catch (A) {
                var E = A.toString();
                throw (
                  (H('failed to compile wasm module: ' + E),
                  (E.includes('imported Memory') ||
                    E.includes('memory import')) &&
                    H(
    ...
    if (
      ((Q.___wasm_call_ctors = T.d),
      (Q._rnnoise_init = T.e),
      (Q._rnnoise_create = T.f),
      (Q._malloc = T.g),
      (Q._rnnoise_destroy = T.h),
      (Q._free = T.i),
      (Q._rnnoise_process_frame = T.j),
      (r = function A() {
        x || Y(), x || (r = A);
      }),
      (Q.run = Y),
  ...
  class g {
    constructor(A) {
      ...
      try {
        if (
          ((this._wasmInterface = A),
          (this._wasmPcmInput = this._wasmInterface._malloc(1920)),
    ...
    _releaseWasmResources() {
      this._wasmPcmInput && this._wasmInterface._free(this._wasmPcmInput),
        this._context && this._wasmInterface._rnnoise_destroy(this._context);
    }
    getSampleLength() {
      return 480;
    }
    ...
    destroy() {
      this._destroyed || (this._releaseWasmResources(), (this._destroyed = !0));
    }
    calculateAudioFrameVAD(A) {
      return this.processAudioFrame(A);
    }
    processAudioFrame(A, g = !1) {
      for (let g = 0; g < 480; g++)
        this._wasmInterface.HEAPF32[this._wasmPcmInputF32Index + g] =
          32768 * A[g];
      const I = this._wasmInterface._rnnoise_process_frame(
        this._context,
        this._wasmPcmInput,
        this._wasmPcmInput,
      );
      if (g)
        for (let g = 0; g < 480; g++)
          A[g] =
            this._wasmInterface.HEAPF32[this._wasmPcmInputF32Index + g] / 32768;
      return I;
    }
  }
  class I extends AudioWorkletProcessor {
    constructor() {
      super(),
        ...
        (this._denoiseProcessor = new g(A())),
        (this._denoiseSampleSize = this._denoiseProcessor.getSampleLength()),
        (this._circularBufferLength = (function (A, g) {
          const I = A,
            Q = g,
            B = (function (A, g) {
              let I = A,
    ...
    process(A, g) {
      ...
      if (!I) return !0;
      for (
        this._circularBuffer.set(I, this._inputBufferLength),
          this._inputBufferLength += I.length;
        this._denoisedBufferLength + this._denoiseSampleSize <=
        this._inputBufferLength;
        this._denoisedBufferLength += this._denoiseSampleSize
      ) {
        const A = this._circularBuffer.subarray(
          this._denoisedBufferLength,
          this._denoisedBufferLength + this._denoiseSampleSize,
        );
        this._denoiseProcessor.processAudioFrame(A, !0);
      }
      let B;
      if (
        ((B =
          this._denoisedBufferIndx > this._denoisedBufferLength
        ...
        const A = this._circularBuffer.subarray(
          ...
          this._denoisedBufferIndx + Q.length,
        );
        Q.set(A, 0), (this._denoisedBufferIndx += Q.length);
      }
      return (
        this._denoisedBufferIndx === this._circularBufferLength &&
          (this._denoisedBufferIndx = 0),
        this._inputBufferLength === this._circularBufferLength &&
          ((this._inputBufferLength = 0), (this._denoisedBufferLength = 0)),
        !0
      );
    }
  }
  registerProcessor('NoiseSuppressorWorklet', I);
})();
